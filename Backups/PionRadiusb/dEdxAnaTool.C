...
//-------------------------------------------------------
    ...
    Double_t Eint        = 0.0;
    Int_t radiusrange=150; //in 0.1 m
    Double_t binsize=10.0; //Convert radius to units of 0.01 m
    Int_t    Radiusbin[radiusrange];    
    Double_t Energybin[radiusrange];
    Int_t    radind      = 0.0;
    Double_t Radiusunbin[120]; 
    Double_t z0 = 0.0;
    Double_t t0 = 0.0;
...
//-------------------------------------------------------
    ...
    tout->Branch("Radiusunbin",&Radiusunbin, "Radiusunbin[120]/D");
...
//Start of Loop through Entries
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      for(Int_t ii=0;ii<120;ii++){Radiusunbin[ii]=-99.0;}; // initialize unbinned array to negatives
...
//#endif
      ...
      for (int i = 0; i < cluster_energy_vec_sz; ++i) {
          ...
          {
              Radiusbin[radind] += 1; //binned radii
              Energybin[radind] += energy;
          }
          
          Radiusunbin[i] = radius; //unbinned radii
