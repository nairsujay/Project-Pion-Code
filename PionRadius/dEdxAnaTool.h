...
// Wed Jul 26 17:14:30 2017 by ROOT version 5.34/14
// from TTree dEdxAnaTool/Tuple created by an AnaTuple managed by AnaTupleManager
// found on file: Pion/SIM_minerva_00000101_Subruns_0046-0047-0048-0049-0050_dEdxAnaTool_Ana_Tuple_v10r8p10-ltrung.root
//////////////////////////////////////////////////////////

#ifndef dEdxAnaTool_h
#define dEdxAnaTool_h
...
public :
   ...
   std::map<std::string,int> __procnum_map;
   std::map<std::string,int> __secprocnum_map;
   ...
   Double_t        prong_length_area_ecal;
   Double_t        prong_length_area_trkr;
   Double_t        prong_mid_u;
   Double_t        prong_mid_v;
   Double_t        prong_mid_x;
   Double_t        prong_mid_y;
   Double_t        prong_mid_z;
   ...
   Int_t           cluster_used_vec[108];   //[cluster_used_vec_sz]
   Int_t           cluster_view_vec_sz;
   Int_t           cluster_view_vec[108];   //[cluster_view_vec_sz]
   ...
   Int_t           track_module_vec[106];   //[track_module_vec_sz]
   Int_t           track_ndigit_vec_sz;
   Int_t           track_ndigit_vec[106];   //[track_ndigit_vec_sz]
   Int_t           track_node_vec_sz;
   Int_t           track_node_vec[3];   //[track_node_vec_sz]
   Int_t           track_plane_vec_sz;
   Int_t           track_plane_vec[106];   //[track_plane_vec_sz]
   ...
   Double_t        cluster_energy_vec[108];   //[cluster_energy_vec_sz]
   Int_t           cluster_time_vec_sz;
   Double_t        cluster_time_vec[108];   //[cluster_time_vec_sz]
   Int_t           cluster_x_vec_sz;
   Double_t        cluster_x_vec[108];   //[cluster_x_vec_sz]
   Int_t           cluster_z_vec_sz;
   Double_t        cluster_z_vec[108];   //[cluster_z_vec_sz]
   ...
   Double_t        recovtx_uvec[8];   //[recovtx_uvec_sz]
   Int_t           recovtx_vvec_sz;
   Double_t        recovtx_vvec[8];   //[recovtx_vvec_sz]
   Int_t           recovtx_xvec_sz;
   Double_t        recovtx_xvec[8];   //[recovtx_xvec_sz]
   Int_t           recovtx_yvec_sz;
   Double_t        recovtx_yvec[8];   //[recovtx_yvec_sz]
   Int_t           recovtx_zvec_sz;
   Double_t        recovtx_zvec[8];   //[recovtx_zvec_sz]
   ...
   Double_t        track_nodex_vec[106];   //[track_nodex_vec_sz]
   Int_t           track_nodey_vec_sz;
   Double_t        track_nodey_vec[106];   //[track_nodey_vec_sz]
   Int_t           track_nodez_vec_sz;
   Double_t        track_nodez_vec[106];   //[track_nodez_vec_sz]
   ...
   Double_t        track_slope_kx_vec[106];   //[track_slope_kx_vec_sz]
   Int_t           track_slope_ky_vec_sz;
   Double_t        track_slope_ky_vec[106];   //[track_slope_ky_vec_sz]
   ...
   Double_t        track_theta_vec[106];   //[track_theta_vec_sz]
   Int_t           track_thetax_vec_sz;
   Double_t        track_thetax_vec[106];   //[track_thetax_vec_sz]
   Int_t           track_thetay_vec_sz;
   Double_t        track_thetay_vec[106];   //[track_thetay_vec_sz]
   ...
   TBranch        *b_prong_length_area_ecal;   //!
   TBranch        *b_prong_length_area_trkr;   //!
   TBranch        *b_prong_mid_u;   //!
   TBranch        *b_prong_mid_v;   //!
   TBranch        *b_prong_mid_x;   //!
   TBranch        *b_prong_mid_y;   //!
   TBranch        *b_prong_mid_z;   //!
   ...
   dEdxAnaTool(TTree *tree=0);
   virtual ~dEdxAnaTool();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(const TString filelist); 
   virtual void     SetMap();
   virtual TChain * InputFiles(const TString file, const TString tr);
...
#ifdef dEdxAnaTool_cxx
dEdxAnaTool::dEdxAnaTool(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Pion/SIM_minerva_00000101_Subruns_0046-0047-0048-0049-0050_dEdxAnaTool_Ana_Tuple_v10r8p10-ltrung.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Pion/SIM_minerva_00000101_Subruns_0046-0047-0048-0049-0050_dEdxAnaTool_Ana_Tuple_v10r8p10-ltrung.root");
      }
      f->GetObject("dEdxAnaTool",tree);

   }
   Init(tree);
}

dEdxAnaTool::~dEdxAnaTool()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t dEdxAnaTool::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dEdxAnaTool::LoadTree(Long64_t entry)
{
...
void dEdxAnaTool::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("prong_length_area_ecal", &prong_length_area_ecal, &b_prong_length_area_ecal);
   fChain->SetBranchAddress("prong_length_area_trkr", &prong_length_area_trkr, &b_prong_length_area_trkr);
   fChain->SetBranchAddress("prong_mid_u", &prong_mid_u, &b_prong_mid_u);
   fChain->SetBranchAddress("prong_mid_v", &prong_mid_v, &b_prong_mid_v);
   fChain->SetBranchAddress("prong_mid_x", &prong_mid_x, &b_prong_mid_x);
   fChain->SetBranchAddress("prong_mid_y", &prong_mid_y, &b_prong_mid_y);
   fChain->SetBranchAddress("prong_mid_z", &prong_mid_z, &b_prong_mid_z);
...
void dEdxAnaTool::Show(Long64_t entry)
{
...
Int_t dEdxAnaTool::Cut(Long64_t entry)
{
